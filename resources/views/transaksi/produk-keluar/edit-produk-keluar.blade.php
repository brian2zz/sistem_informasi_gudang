            ...
            <div class="row">
                <div class="col-12">
                    <div class="card mb-4 mx-4 ">
                        ...
                        @foreach ($produkKeluar as $ProdukKeluar)
                            <div class="card-body mb-4 mx-4 mr-1">
                                <form method="POST" action="{{ url('produk-keluar-edit/'.$ProdukKeluar->id_produk_keluar.'/action') }}">
                                    @csrf
                                    <input type="hidden" name="id_produk_keluar" value="{{ $ProdukKeluar->id_produk_keluar }}" />
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control selectpicker" name="customer" id="customer" required>
                                                ...
                                                @foreach ($customer as $Customer)
                                                    <option data-tokens="algk" value="{{ $Customer->id_pembeli }}"{{ $ProdukKeluar->id_pembeli == $Customer->id_pembeli ? 'selected':''}}>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control selectpicker" name="supplier" id="tujuan" required>
                                                <option disabled value="" selected>Pilih Asal Barang</option>
                                                @foreach ($supplier as $Supplier)
                                                    <option data-tokens="algk" value="{{ $Supplier->id_supplier }}" {{ $ProdukKeluar->id_supplier == $Supplier->id_supplier ? 'selected':''}}>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="date" class="form-control" value="{{ $ProdukKeluar->tanggal_keluar }}" id="tanggal_keluar" name="tanggal_keluar" required>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="keterangan">Keterangan</label>
                                        <input type="text" class="form-control" value="{{ $ProdukKeluar->keterangan }}" id="keterangan" name="keterangan" required>
                                    </div>
                                    <div id="user_table">

                                        @foreach ($ProdukKeluar->product as $data)
                                            <div id="row_user_table{{ $loop->iteration }}">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <input type="number" class="form-control" value="{{ $data->pivot->jumlah_keluar }}" id="jumlah_keluar" name="jumlah_keluar[]" required>
                                                    </div>
                                                    @if($loop->iteration == 1)
            ...
            $('#user_table').append('<div class="row" id="row_user_table' + i +'">'+
                    '<div class="form-group col-md-3">'+
                        ...
                        '<div class="form-group col-md-3">'+
                            ...
                            '<input type="number" class="form-control" id="jumlah_masuk" name="jumlah_keluar[]" required>'+
                        '</div>'+
                        '<div class="form-group col mt-4 pt-2">'+
