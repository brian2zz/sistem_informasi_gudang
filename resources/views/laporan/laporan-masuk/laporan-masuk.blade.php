    ...
    <div class="row">
        <div class="col-12">
            <div class="card mb-4 mx-4">
                ...
                <div class="card-body">
                    <form action="{{ url('/laporan-produk-masuk/filter') }}" method="post">
                        @csrf
                        <div class="row">
        ...
        <div class="col-12">
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        <div>
                            <h5 class="mb-0">Laporan Masuk</h5>
                        </div>
                        <button type="button" class="btn bg-gradient-primary btn-sm mb-0" onclick="tablesToExcel(['export_laporan_masuk'], 'LaporanMasuk' , 'Laporan Masuk.xls', 'Excel')">
                            +&nbsp; Export
                          </button>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="produk" class="table align-items-center mb-0">
                            ...
                            <tbody>
                                @foreach($laporan_masuk as $laporan)
                                    @foreach ($laporan->products as $Produk )
                                        <tr>
                                            <td class="ps-4">
                                                <p class="text-xs font-weight-bold mb-0">{{ $laporan->tanggal_masuk }}</p>
                                            </td>
                                            <td class="ps-sm-4">
                                            ...
                                            <td class="ps-sm-4">
                                                <p class="text-xs font-weight-bold mb-0">{{ $Produk->pivot->jumlah_masuk }}</p>
                                            </td>
                                            <td class="ps-sm-4">
                                                <p class="text-xs font-weight-bold mb-0">{{ $Produk->pivot->sisa_stok_masuk }}</p>
                                            </td>
                                            <td class="ps-sm-4">
                        ...
                        @include('laporan.tabel-export.table-laporan-masuk')
                    </div>
                </div>
