            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-bolder text-info text-gradient">Sistem Informasi Customer </h3>
                ...
                <div class="card-body">
                  <form role="form" method="POST" action="/session">
                    @csrf
                    <input type="text" value="1" class="form-control" name="type" hidden>
                    <label>Email</label>
                    <div class="mb-3">
                    ...
                    <div class="text-center">
                      <a href="{{ url('/login') }}">
                        <button type="button" class="btn bg-gradient-secondary w-100 mt-4 mb-0">Sistem Informasi Gudang</button>
                      </a>
                    </div>
                  </form>
                </div>
